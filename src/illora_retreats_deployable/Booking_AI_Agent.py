...
class Booking_IloraRetreatsConciergeBot:
    """
    ...
    **Optimized with background data refreshing to ensure fast response times.**
    ...
    def __init__(self):
        ...
        logger.info(f"Booking ConciergeBot ready with {self.llm_model_name}.")
