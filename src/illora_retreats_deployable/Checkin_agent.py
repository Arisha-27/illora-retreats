...
class CheckIn_IloraRetreatsConciergeBot:
    """
    ...
    **Optimized with background data refreshing to ensure fast response times.**
    """
    def __init__(self):
        print("[DEBUG] Initializing CheckinAIBot (Gemini Powered)...")
        ...
        logger.info(f"Checkin ConciergeBot ready with {self.llm_model_name}.")
